  ...
  const navLinks = [
    ...
    },
    {
      ...
      submenu: [
        ...
        { href: "/learn?type=ielts-guide", label: "IELTS Guide" },
        { href: "/learn?type=reading", label: "Reading" },
        { href: "/learn?type=listening", label: "Listening" },
        { href: "/learn?type=writing", label: "Writing" },
        { href: "/learn?type=speaking", label: "Speaking" },
      ],
    },
