...
export default function WritingSampleDetail({ sample }: { sample: WritingSample }) {
  ...
  function renderRichText(content: WritingSample["fields"]["answer"]) {
      ...
      if (node.nodeType === "heading-1") {
        return (
          <h1 key={index} className="text-3xl font-bold mb-6 text-gray-800">
            {node.content
              ?.map((textNode: any, textIndex: number) => textNode.value)
              .join("")}
          </h1>
        );
      }
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-10 mb-12 border border-gray-100">
          <div className="flex items-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-gray-800">Model Answer</h2>
          </div>
        ...
        <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-2xl p-8 mb-12 border border-red-200">
          <div className="flex items-center mb-6">
            ...
            <h3 className="text-2xl font-bold text-red-800">Writing Tips</h3>
          </div>
      ...
      {isLightboxMounted && sample.fields.image && (
        <div
          className={`fixed inset-0 z-50 flex items-center justify-center p-4 transition-opacity duration-200 ease-out ${
            isLightboxVisible ? "bg-black/80 opacity-100" : "bg-black/0 opacity-0"
          }`}
